<div class="w-4/5 mx-auto py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-semibold text-gray-800">PF Locations</h1>
    ...
    <!-- Modals -->
    <?php include 'views/modals/add-pf-location.php'; ?>
</div>
...
<script>
    ...
    async function fetchLocations(page = 1) {
        ...
        const entityTypeId = PF_LOCATIONS_ENTITY_ID;
        const apiUrl = `${baseUrl}/crm.item.list?entityTypeId=${entityTypeId}&order[id]=desc&select[0]=id&select[1]=ufCrm22Location&start=${(page - 1) * pageSize}`;
        ...
        try {
            ...
            locationList.innerHTML = locations
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">${location.ufCrm22Location || 'N/A'}</td>
    ...
    async function deleteLocation(locationId) {
        const baseUrl = API_BASE_URL;
        const apiUrl = `${baseUrl}/crm.item.delete?entityTypeId=${PF_LOCATIONS_ENTITY_ID}&id=${locationId}`;
