                ...
                <tr>
                    ...
                    <td class="px-3 py-4 whitespace-nowrap text-xs font-medium text-gray-800">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu shadow absolute z-10" style="max-height: 60vh; overflow-y: auto; scrollbar-width: thin; scrollbar-color: #6B7280 #f9fafb; font-size:medium;">
                                ...
                                <li>
                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#referenceModal" data-property-id="${property.id}" data-reference="${property.ufCrm18ReferenceNumber}">
                   ...
                   <td class="px-3 py-4 whitespace-nowrap text-xs font-medium text-gray-800">
                        <div class="flex gap-1">
                            ...
                            ${property.ufCrm18WebsiteEnable === "Y" ? '<img class="w-8 h-8 rounded-full object-cover bg-black" src="assets/images/company-logo.webp" alt="X10 Real Estate" title="X10 Real Estate">' : ''}
                        </div>
                    </td>
                    <td class="px-3 py-4 whitespace-nowrap text-xs font-medium text-gray-800">
