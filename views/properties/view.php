...
<script>
    ...
    async function fetchProperty(id) {
        ...
        if (data.result && data.result.item) {
            ...
            document.getElementById('property-title').textContent = property.ufCrm18TitleEn || 'No title available';
            document.getElementById('property-description').innerHTML = '<pre>' + property.ufCrm18DescriptionEn + '</pre>' || 'No description available';
            document.getElementById('property-city').textContent = property.ufCrm18City || 'N/A';
            document.getElementById('property-community').textContent = property.ufCrm18Community || 'N/A';
            let priceText = property.ufCrm18Price ? formatPrice(property.ufCrm18Price) : 'N/A';
            if (property.ufCrm18RentalPeriod && property.ufCrm18RentalPrice) {
                ...
                const rentalPeriod = rentalPeriodMapping[property.ufCrm18RentalPrice] || property.ufCrm18RentalPeriod;
                priceText += `/ ${rentalPeriod}`;
            }
            document.getElementById('property-price').textContent = priceText;
            document.getElementById('property-size').textContent = property.ufCrm18Size ? `${property.ufCrm18Size} sqft` : 'N/A';
            document.getElementById('property-bedrooms').textContent = property.ufCrm18Bedroom || 'N/A';
            document.getElementById('property-bathrooms').textContent = property.ufCrm18Bathroom || 'N/A';
            document.getElementById('property-type').textContent = property.ufCrm18PropertyType || 'N/A';
            document.getElementById('property-location').textContent = property.ufCrm18Location || 'N/A';
            document.getElementById('property-status').textContent = property.ufCrm18Status || 'N/A';
            document.getElementById('property-owner').textContent = property.ufCrm18ListingOwner || 'N/A';
            document.getElementById('agent-name').textContent = property.ufCrm18AgentName || 'N/A';
            document.getElementById('agent-phone').textContent = property.ufCrm18AgentPhone || 'N/A';
            document.getElementById('agent-email').textContent = property.ufCrm18AgentEmail || 'N/A';
            document.getElementById('main-image').src = property.ufCrm18PhotoLinks[0] || 'https://placehold.jp/150x150.png';

            const images = property.ufCrm18PhotoLinks || [];
            ...
            const comments = property.ufCrm18Notes || [];
