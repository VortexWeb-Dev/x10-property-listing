<div class="w-4/5 mx-auto py-8">
    ...
    <div id="developer-table" class="flex flex-col hidden">
...
<script>
    ...
    async function fetchDevelopers(page = 1) {
        ...
        const apiUrl = `${baseUrl}/crm.item.list?entityTypeId=${DEVELOPERS_ENTITY_ID}&order[id]=desc&select[0]=id&select[1]=ufCrm26DeveloperName&start=${(page - 1) * pageSize}`;
        ...
        try {
            ...
            developerList.innerHTML = developers
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">${developer.ufCrm26DeveloperName || 'N/A'}</td>
    ...
    async function deleteDeveloper(developerId) {
        const baseUrl = API_BASE_URL;
        const apiUrl = `${baseUrl}/crm.item.delete?entityTypeId=${DEVELOPERS_ENTITY_ID}&id=${developerId}`;
