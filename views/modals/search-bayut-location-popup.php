    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const searchItems = async (query) => {
            ...
            const data = {
                ...
                select: ["id", "ufCrm24Location", "ufCrm24City", "ufCrm24Community", "ufCrm24SubCommunity", "ufCrm24Building"],
                filter: {
                    "%ufCrm24Location": query
                }
            };
        ...
        const updateResultContainer = (items) => {
            ...
            if (items.length > 0) {
                items.forEach(item => {
                    ...
                    itemElement.innerText = item.ufCrm24Location;

                    itemElement.addEventListener('click', () => {
                        searchInput.value = item.ufCrm24Location;
                        togglePopup(false);
                        autofillLocation(item.ufCrm24Location, item.ufCrm24City, item.ufCrm24Community, item.ufCrm24SubCommunity, item.ufCrm24Building);
                    });
