    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const searchItems = async (query) => {
            ...
            const data = {
                ...
                select: ["id", "ufCrm22Location", "ufCrm22City", "ufCrm22Community", "ufCrm22SubCommunity", "ufCrm22Building"],
                filter: {
                    "%ufCrm22Location": query
                }
            };
        ...
        const updateResultContainer = (items) => {
            ...
            if (items.length > 0) {
                items.forEach(item => {
                    ...
                    itemElement.innerText = item.ufCrm22Location;

                    itemElement.addEventListener('click', () => {
                        searchInput.value = item.ufCrm22Location;
                        togglePopup(false);
                        autofillLocation(item.ufCrm22Location, item.ufCrm22City, item.ufCrm22Community, item.ufCrm22SubCommunity, item.ufCrm22Building);
                    });
