            ...
            fetch(webhookUrl, {
                ...
                .then(data => {
                    ...
                    if (items.length > 0) {
                        ...
                        items.forEach(item => {
                            if (!uniqueCities.has(item.ufCrm22City)) {
                                uniqueCities.add(item.ufCrm22City);
                        ...
                        uniqueItems.forEach(item => {
                            ...
                            itemElement.innerHTML = item.ufCrm22City;

                            itemElement.addEventListener('click', function() {
                                searchInput.value = item.ufCrm22City;
                                popup.classList.add('d-none');
                                resultContainer.innerHTML = '';
                            });
