    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const searchItems = (query) => {
            ...
            const data = {
                ...
                "select": ["id", "ufCrm22SubCommunity"], // Updated field name
                "filter": {
                    "%ufCrm22SubCommunity": query // Updated field name in filter
                }
            };
            ...
            fetch(webhookUrl, {
                ...
                .then(data => {
                    ...
                    if (items.length > 0) {
                        ...
                        items.forEach(item => {
                            if (!uniqueSubCommunities.has(item.ufCrm22SubCommunity)) {
                                uniqueSubCommunities.add(item.ufCrm22SubCommunity);
                        ...
                        uniqueItems.forEach(item => {
                            ...
                            itemElement.innerHTML = item.ufCrm22SubCommunity;

                            itemElement.addEventListener('click', function() {
                                searchInput.value = item.ufCrm22SubCommunity;
                                popup.classList.add('d-none');
                                resultContainer.innerHTML = '';
                            });
