    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const searchItems = (query) => {
            ...
            const data = {
                ...
                "select": ["id", "ufCrm22Building"], // Updated field name
                "filter": {
                    "%ufCrm22Building": query // Updated field name in filter
                }
            };
            ...
            fetch(webhookUrl, {
                ...
                .then(data => {
                    ...
                    if (items.length > 0) {
                        ...
                        items.forEach(item => {
                            if (!uniqueBuildings.has(item.ufCrm22Building)) {
                                uniqueBuildings.add(item.ufCrm22Building);
                        ...
                        uniqueItems.forEach(item => {
                            ...
                            itemElement.innerHTML = item.ufCrm22Building;

                            itemElement.addEventListener('click', function() {
                                searchInput.value = item.ufCrm22Building;
                                popup.classList.add('d-none');
                                resultContainer.innerHTML = '';
                            });
