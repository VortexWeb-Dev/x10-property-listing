...
<script>
    ...
    function handleAddAgent(e) {
        ...
        const fields = {
            "ufCrm20AgentId": data.pfId.trim(),
            "ufCrm20AgentName": data.agentName.trim(),
            "ufCrm20AgentEmail": data.agentEmail.trim(),
            "ufCrm20AgentMobile": data.agentMobile.trim(),
            "ufCrm20AgentLicense": data.agentLicense.trim(),
            "ufCrm20AgentPhoto": data.agentPhoto.trim(),
        };
